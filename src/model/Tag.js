...
Tag.prototype = {
    ...
    createTag: function() {
        ...
        tag.position.set(this.arena.cellDim*(_.random(-this.arena.gridBounds+this.arena.cellDim,this.arena.gridBounds-this.arena.cellDim)),0,this.arena.cellDim*(_.random(-this.arena.gridBounds+this.arena.cellDim,this.arena.gridBounds-this.arena.cellDim)));
        this.object = tag;
        return this.object;
    },
    render: function(tag) {
